...
{
    public partial class createbranchanduserbranchbookingtables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBranchBooking", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserBranchBooking_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBranchBooking_BranchId",
                table: "UserBranchBooking",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBranchBooking_UserId",
                table: "UserBranchBooking",
                column: "UserId");
        }
